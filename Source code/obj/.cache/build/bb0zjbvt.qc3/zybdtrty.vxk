...
<html>
  ...
  <div class="markdown level1 summary"><p>The Frame class contains functions for building the frame.</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>A list of the B2Beams, used to booleanpart cut the flashings if they overlap.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">Tekla.Structures.Model.PolyBeam</span></td>
        <td><p>This is a polybeam part, it&apos;s used to cut the front beams</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Boolean</span></td>
        <td><p>A boolean which is true if the seating plate is ment to be on the right hand side of the front beam</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Boolean</span></td>
        <td><p>Boolean parameter. If true means that there&apos;s a split on side 1.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Boolean</span></td>
        <td><p>Boolean parameter. If true means that there&apos;s a split on side 3.</p>
</td>
      </tr>
    </tbody>
  </table>
