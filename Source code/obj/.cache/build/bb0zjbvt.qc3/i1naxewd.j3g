...
<html>
  ...
  <div class="markdown level0 summary"><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">The class for the camera arm, containing its attributes and functions to generate a camera arm for the structure</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates the lower baseplate for the camera arm</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="TeklaBillboardAid.Plate.html">Plate</a></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates the upper baseplate for the camera arm</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="TeklaBillboardAid.Plate.html">Plate</a></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates an additional left support plate</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="TeklaBillboardAid.Plate.html">Plate</a></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates an additional right support plate</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="TeklaBillboardAid.Plate.html">Plate</a></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates the left complex support plate</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="TeklaBillboardAid.Plate.html">Plate</a></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.CameraArm.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Indicates the right complesx support plate</p>
</td>
      </tr>
    </tbody>
  </table>
