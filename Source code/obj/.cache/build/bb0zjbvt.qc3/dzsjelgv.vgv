...
<html>
  ...
  <div class="markdown level1 summary"><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="2" sourceendlinenumber="10">Constructor for a single lifting point.
...
<param name="boltStandard"></p>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.String</span></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">The material of the lifting point plate.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.String</span></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="2" sourceendlinenumber="2">The profile of the lifting point plate.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="1" sourceendlinenumber="1">List of (relative) column x coordinates (mm) </p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.Collections.IList</span></td>
        <td><span class="parametername">liftList</span></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="1" sourceendlinenumber="1">List of (absolute) x coordinates of existing lifting points (mm) </p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.Double</span></td>
        <td><span class="parametername">xOld</span></td>
        <td><p sourcefile="obj/api/TeklaBillboardAid.LiftPoint.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The old x value of the lifting point if &apos;Edit&apos; is selected (mm) </p>
</td>
      </tr>
    </tbody>
  </table>
